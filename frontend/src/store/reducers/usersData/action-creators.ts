...
export const UsersDataActionCreators = {
	clearUsersData: (): ClearUsersDataAction => ({
		type: UsersDataActionEnum.CLEAR_USERS_DATA,
	}),
	setUsersData: (payload: IUser[]): SetUsersDataAction => ({
		type: UsersDataActionEnum.SET_USERS_DATA,
		payload,
	}),
	setIsLoadingUsersData: (payload: boolean): SetIsLoadingUsersDataAction => ({
		type: UsersDataActionEnum.SET_USERS_DATA_IS_LOADING,
		payload,
	}),
	setErrorUsersData: (payload: string): SetErrorUsersDataAction => ({
		type: UsersDataActionEnum.SET_ERROR_USERS_DATA,
		payload,
	}),
	addUserData: (payload: IUser): AddUserDataAction => ({
