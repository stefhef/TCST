...
export const TaskPreviewTeacher: (props: ITaskPreviewTeacher) => JSX.Element = (
	props: ITaskPreviewTeacher
) => {
	const [solutionsCount, setSolutionsCount] =
		useState<ISolutionCountResponse>();
			...
			<BorderShadowBox padding="0.5vw" mb="5px">
				<Grid templateColumns="repeat(20, 1fr)">
					...
					<GridItem colSpan={4} colEnd={21} justifySelf={'flex-end'}>
						<SkeletonText isLoaded={Boolean(isLoaded)} noOfLines={1}>
							<HStack>
								<Text align="right" color={'green.600'}>
									<Icon
										as={BsFillPeopleFill}
								...
								<Text align="right" color={'green.300'}>
									<Icon
										as={BsFillPeopleFill}
										verticalAlign="middle"
										w="6"
								...
								<Text align="right" color={'yellow.500'}>
									<Icon
										as={BsFillPeopleFill}
										verticalAlign="middle"
										w="6"
								...
								<Text align="right" color={'red.500'}>
									<Icon
										as={BsFillPeopleFill}
										verticalAlign="middle"
										w="6"
								...
								<Text align="right" color={'gray.500'}>
									<Icon
										as={BsFillPeopleFill}
										verticalAlign="middle"
										w="6"
				...
				<Progress
					colorScheme={'const_green'}
					size="lg"
					borderRadius="lg"
					value={
						((solutionsCount?.solutions_complete_count! +
							solutionsCount?.solutions_complete_not_max_count!) /
							solutionsCount?.solutions_count!) *
						100
					}
